...
def format_vaulttext_envelope(b_ciphertext, cipher_name=DEFAULT_CIPHER, version='1.1', vault_id=None):
...
class VaultAES256:
    ...
    def _gen_salt(b_plaintext=None, secret=None):
        ...
        # broothforce the plaintext content. This is not a problem for larger files, where
